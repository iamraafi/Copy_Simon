...
public class HighScoreActivity extends AppCompatActivity {
    ...
    private void intialize(DatabaseHelper db){
        ...
        if(in!=null)
            return;
        dbhelper.addScore(new Score("Tom",100),Score.TABLE_NAME);
        dbhelper.addScore(new Score("Jake",90),Score.TABLE_NAME);
        dbhelper.addScore(new Score("Hassan",80),Score.TABLE_NAME);
        dbhelper.addScore(new Score("Ching",70),Score.TABLE_NAME);
        dbhelper.addScore(new Score("Cho",60),Score.TABLE_NAME);
        dbhelper.addScore(new Score("Hans",50),Score.TABLE_NAME);
        dbhelper.addScore(new Score("Nick",40),Score.TABLE_NAME);
        dbhelper.addScore(new Score("Juan",30),Score.TABLE_NAME);
        dbhelper.addScore(new Score("Samael",20),Score.TABLE_NAME);
        dbhelper.addScore(new Score("Jamal",15),Score.TABLE_NAME);
